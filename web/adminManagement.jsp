                ...
                <div class="user-info">
                    <div class="search-box">
                        <form action="MainController">
                            ...
                            <button type="submit" name="action" value="GetListUser" style="background-color: #F9F9F9">Search</button>
                        </form>
                    </div>
                ...
                <div class="table-container ">
                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            %>
                            <tr>
                                <td class="Id" style="padding-bottom: 20px; padding-top: 20px"><%=user.getId()%></td>
