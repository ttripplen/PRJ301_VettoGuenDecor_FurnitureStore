            ...
            <div class="tabular-wrapper ">
                ...
                <div class="table-container ">
                    ...
                    <table>
                        <thead>
                            <tr>
                                <th class="Id" style="padding-left: 40px">ID</th>
                                <th style="padding-right: 120px">Name</th>
                                <th><img>Image</th>
                                <th>Description</th>
                        ...
                        <form action="MainController" method="POST">
                            ...
                            <td>
                                <input style="background-color: <%=color%>; padding-left: 10px" type="number" step="0.01" name="price" value="<%=product.getPrice()%>">
                            </td>
                            <td>
                                <input style="background-color: <%=color%>; padding-left: 20px" type="number" name="quantity" value="<%=product.getQuantity()%>">
                            </td>
                            <td>
